      ...
      <div className="container-home">
        <div className="content_home">
          <div className="home_esquerda">
            ...
            <p>
              Bem-vindo ao restaurante delivery de comida japonesa mais quente
              da região!
              <br />
              Aqui no JapaCasa! você encontra as melhores delícias da Terra do
              Sol Nascente sem precisar sair de casa.
            </p>
          </div>
        ...
        <div className="content_carda">
          ...
          <div className="home_direita">
            <h2>
              Confira o nosso cardápio e escolha a sua próxima paixão culinária!{" "}
            </h2>
        ...
        <div className="content_breve">
          ...
          <div className="home_breve">
            ...
            <h3>Estamos reformando nossa unidade física para recebê-lo!</h3>
          </div>
        </div>
